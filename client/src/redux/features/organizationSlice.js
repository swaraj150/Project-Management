...
export const organizationSlice = createSlice({
  ...
  reducers: {
    ...
    addMember: (state, action) => {
      ...
      state.members = [...state.members, userId]
      switch (projectRole) {
        case roles.projectManager:
          state.managers = [...state.managers, userId]
          break
        case roles.developer:
          state.developers = [...state.developers, userId]
          break
        case roles.qa:
          state.testers = [...state.testers, userId]
          break
        case roles.stakeholder:
          state.stakeholders = [...state.stakeholders, userId]
          break
      }
      state.membersMap = {
        ...state.membersMap,
    ...
    changeMemberRole: (state, action) => {
      ...
      switch (newRole) {
        case roles.projectManager:
          state.managers = [...state.managers, memberId]
          break
        case roles.developer:
          state.developers = [...state.developers, memberId]
          break
        case roles.qa:
          state.testers = [...state.testers, memberId]
          break
        case roles.stakeholder:
          state.stakeholders = [...state.stakeholders, memberId]
          break
      }
      state.membersMap = {
        ...state.membersMap,
        [memberId]: {
          ...state.membersMap[memberId],
          projectRole: newRole,
        },
      }
    },
